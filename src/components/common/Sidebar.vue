<template>
  <aside class="sidebar">
    ...
    <div class="social">
      <a href="https://github.com/alexsommers7" target="_blank" aria-label="Link to Github Profile">
      ...
      <a href="https://codepen.io/al_somz7" target="_blank" aria-label="Link to Codepen Profile">
